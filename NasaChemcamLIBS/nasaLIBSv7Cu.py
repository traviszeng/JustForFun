...
if __name__=='__main__':
    ...
    REPEAT_TIMES = 50
    if not os.path.exists("E:\\LIBS_experiment\\" + element + 'v7_version0520'):
        os.mkdir("E:\\LIBS_experiment\\" + element + 'v7_version0520')
    os.chdir("E:\\LIBS_experiment\\" + element + 'v7_version0520')
